...
internal static class VarianceSample
{
    ...
    // inharitance
    //public interface IMain<in T> // CONTRAvariant: T or any derivative class
    //{
    //    void Consume(T param);
    //}

    //public interface ISubs<T>: IMain<T> // have to specify or stick to 'HAS TO BE THE SAME'
    //{
    //    T Produce();
    //}
